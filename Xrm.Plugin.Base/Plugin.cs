...
namespace Xrm.Plugin.Base
{
    ...
    {
        protected static string PreImageName = "PreImage";
#pragma warning disable
        private readonly string unsecureConfig, secureConfig;
#pragma warning enable
        ...
        public Plugin(Type childClassName, string unsecureConfig, string secureConfig)
        {
            this.ChildClassName = childClassName.ToString();
        ...
        protected T GetInput<T>(LocalPluginContext pluginContext, string key)
        {
            return pluginContext.PluginExecutionContext.InputParameters.ContainsKey(key) ?
                        (T)pluginContext.PluginExecutionContext.InputParameters[key]
                        : default(T);
        }

        protected void SetOutput(LocalPluginContext pluginContext, string key, object value)
        {
            pluginContext.PluginExecutionContext.OutputParameters[key] = value;
        }
